...
function seasonCardHtml(p){
  ...
  (function(){
    ...
    window.__OBSERVER_FM_MAP_CLEANUP_1660__={version:'v1.73.0',issues,obsoleteClover130131Removed:true,obsoleteClover142145Removed:true,lateMapBehaviorPreserved:true,retiredSlot6FlagsPurged:true};
    if(issues.length) console.error('[v1.72.0] late-map audit',issues);
  })();
  ...
  (function(){
    ...
    window.__OBSERVER_FM_V173_AUDIT__={version:'v1.73.0',ids,bans,sets,issues};
    if(issues.length) console.error('[v1.72.0] league map audit',issues);
  })();
})();
