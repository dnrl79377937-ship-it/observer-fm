...
function applyMapSet776(){
  ...
  const meta={
    ...
    double_hairpin:{slot:6,name:"세잎 클로버",en:"Three-Leaf Clover",theme:"Tropical Clover Circuit",tags:["세잎클로버","우측루프","반시계"],image:"map_clover_153.png?v=1610",special:{shortcuts:false,obstacles:false,wideRoad:false,multiRoute:false,verticality:false}},
...
applyMapSet776();
  ...
  function applyGeometry777(){
    ...
    set777("double_hairpin",{
      image:"map_clover_153.png?v=1610",imageSize:{w:1122,h:1402},
      logicalSize:{w:142.451,h:178},
  ...
  function applyPatch787(){
    ...
    const black=MAP_DEFINITIONS_770.double_hairpin;
    if(black){
      black.image="map_clover_153.png?v=1610";
...
function observerCountForMap120(map){
  ...
  function applyPatch130(){
    ...
    Object.assign(clover,{
      ...
      tags:["세잎클로버","우측루프","반시계"],
      image:"map_clover_153.png?v=1610",imageSize:{w:1536,h:1536},logicalSize:{w:178,h:178},
      route770:[
  ...
  function applyPatch131(){
    const clover=MAP_DEFINITIONS_770.double_hairpin;
    if(!clover)return;
    clover.image="map_clover_153.png?v=1610";
  ...
  window.__OBSERVER_FM_V132__={
    ...
    cloverAsset:"map_clover_153.png?v=1610",compatibilityMapId:"double_hairpin"
  };
  ...
  // ============================================================
  function applyPatch1610(){
    // v1.61.0: single authoritative Three-Leaf Clover definition.
    // START(left yellow) -> 9 -> 11 -> 12 -> 1 -> 3 -> 5 -> GOAL(right green).
    const clover=MAP_DEFINITIONS_770.double_hairpin;
    if(!clover)return;
    const r=[
      [73.5,162.6],[70,155],[67,147],[66,137],[66,126],[64,117],
    ...
    Object.assign(clover,{
      name:'Three-Leaf Clover',en:'Three-Leaf Clover',image:'map_clover_153.png?v=1610',
      imageSize:{w:1254,h:1254},logicalSize:{w:178,h:178},miniCrop:{x:0,y:0,w:178,h:178},
      route770:r,widths770:new Array(r.length-1).fill(9.8),
      start:{x:73.5,y:162.6},goal:{x:104.4,y:162.7},
      safeZones:{start:{x0:69,y0:158,x1:78,y1:168},goal:{x0:100,y0:158,x1:109,y1:168}},
      ...
      strictRoadFollow778:true,strictNoChord795:true,roadFollowMode778:'clover-v161-single-authority',
      ...
      clover130:false,cloverRightBranch130:false,cloverCounterClockwise130:false,cloverOrderLock147:false,cloverDirectSplineMovement148:false,
      observerCount797:150
    });
    const centre=densifyLine772(r,.10);
    clover.racingSpline770=centre; clover.globalOptimal770=centre;
    clover.lockOptimalExecution784=true; clover.optimizedSplineAuthority783=true;
    clover.racingLineMode772='yellow-9-11-12-1-3-5-green-v161';
    POINT_TO_POINT_MAPS_775.add('double_hairpin'); CIRCUIT_MAPS_775.delete('double_hairpin');
    // If Clover is active, rebuild every runtime route from this same authority.
    if(currentMap770()?.id==='double_hairpin'){
