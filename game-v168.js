...
function observerCountForMap120(map){
  ...
  (function applyMapCleanup1620(){
    ...
    // v1.68.0 cleanup step 6: purge every retired slot-6 flag left by v7.x patches.
  ...
  (function auditLateMaps1650(){
    ...
    window.__OBSERVER_FM_MAP_CLEANUP_1660__={version:'v1.68.0',issues,obsoleteClover130131Removed:true,obsoleteClover142145Removed:true,lateMapBehaviorPreserved:true,retiredSlot6FlagsPurged:true};
    if(issues.length) console.error('[v1.68.0] late-map audit',issues);
  })();
