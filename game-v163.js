...
window.__OBSERVER_FM_BUILD__ = BUILD_ID;
  ...
  function setupLeagueHeat100(){
    ...
    if(!mapResult100.ok){
      console.error("[v1.63.0] league map activation failed",mapResult100);
...
function applyMapSet776(){
  ...
  const meta={
    ...
    double_hairpin:{slot:6,name:"세잎 클로버",en:"Three-Leaf Clover",theme:"Tropical Clover Circuit",tags:["세잎클로버","우측루프","반시계"],image:"map_clover_153.png?v=1630",special:{shortcuts:false,obstacles:false,wideRoad:false,multiRoute:false,verticality:false}},
  ...
  if(!keep.includes(activeMapId770)){
    ...
    console.error("[v1.63.0] active map id is outside the canonical roster:",activeMapId770);
  }
}
applyMapSet776();
  ...
  function applyGeometry777(){
    ...
    set777("double_hairpin",{
      image:"map_clover_153.png?v=1630",imageSize:{w:1122,h:1402},
      logicalSize:{w:142.451,h:178},
  ...
  function applyPatch787(){
    ...
    const black=MAP_DEFINITIONS_770.double_hairpin;
    if(black){
      black.image="map_clover_153.png?v=1630";
...
function observerCountForMap120(map){
  ...
  function applyPatch130(){
    ...
    Object.assign(clover,{
      ...
      tags:["세잎클로버","우측루프","반시계"],
      image:"map_clover_153.png?v=1630",imageSize:{w:1536,h:1536},logicalSize:{w:178,h:178},
      route770:[
  ...
  function applyPatch131(){
    const clover=MAP_DEFINITIONS_770.double_hairpin;
    if(!clover)return;
    clover.image="map_clover_153.png?v=1630";
  ...
  window.__OBSERVER_FM_V132__={
    ...
    cloverAsset:"map_clover_153.png?v=1630",compatibilityMapId:"double_hairpin"
  };
  ...
  (function auditCanonicalMapIds1630(){
    const issues=[];
    ...
    if(issues.length)console.error("[v1.63.0] map registry audit",issues);
  ...
  (function applyMapCleanup1620(){
    ...
    Object.assign(clover,{
      ...
      image:'map_clover_153.png?v=1620',imageSize:{w:1254,h:1254},logicalSize:{w:178,h:178},miniCrop:{x:0,y:0,w:178,h:178},
