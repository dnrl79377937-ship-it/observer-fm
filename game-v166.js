...
function observerCountForMap120(map){
  ...
  // v1.66.0 cleanup: obsolete v1.42 Clover geometry override removed.
  ...
  // ============================================================
  // v1.66.0 — CANONICAL DISPLAY LABELS
  // Geometry/image mutations formerly mixed into v1.42 were removed.
  // ============================================================
  (function applyCanonicalLabels1660(){
    const labels={
  ...
  // v1.66.0 cleanup: obsolete v1.43 Clover image/observer override removed.
  ...
  // v1.66.0 cleanup: obsolete v1.45 Clover geometry override removed; Space camera behavior retained.
  ...
  (function auditCanonicalMapIds1630(){
    ...
    if(issues.length)console.error("[v1.64.0] map registry audit",issues);
  ...
  (function applyMapCleanup1620(){
    ...
    Object.assign(clover,{
      ...
      image:'map_clover_164.png?v=1620',imageSize:{w:1254,h:1254},logicalSize:{w:178,h:178},miniCrop:{x:0,y:0,w:178,h:178},
  ...
  (function auditLateMaps1650(){
    ...
    window.__OBSERVER_FM_MAP_CLEANUP_1660__={version:'v1.66.0',issues,obsoleteClover130131Removed:true,obsoleteClover142145Removed:true,lateMapBehaviorPreserved:true};
    if(issues.length) console.error('[v1.66.0] late-map audit',issues);
  })();

  // v1.65.0 starts on the randomized matchup board.
  resetLeague100();
})();
