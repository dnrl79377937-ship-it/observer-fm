...
// ============================================================
// v1.56.0 — repository-baseline recovery + Clover single authority
// Built from the actual game-v153.js loaded by the uploaded repository.
// ============================================================
(function applyPatch1560(){
  const clover=MAP_DEFINITIONS_770?.double_hairpin;
  if(!clover) return;
  const r=[
    [66,166],[66,156],[66,145],[65,132],[61,119],
    [52,112],[41,110],[31,105],[22,97],[16,87],[14,76],[17,65],[23,56],[32,49],[43,45],[54,46],[64,52],
    [71,58],[72,50],[69,41],[68,31],[70,22],[76,15],[84,11],[89,10],[95,11],[103,15],[108,22],[110,31],[109,41],[106,50],[107,58],
    [114,52],[124,46],[135,45],[146,49],[155,56],[161,65],[164,76],[162,87],[156,97],[147,105],[137,110],[126,112],[117,119],
    [113,132],[112,145],[112,156],[112,166]
  ];
  Object.assign(clover,{
    name:'Three-Leaf Clover',en:'Three-Leaf Clover',
    image:'map_clover_156.png?v=1560', imageSize:{w:1254,h:1254}, logicalSize:{w:178,h:178},
    miniCrop:{x:0,y:0,w:178,h:178}, route770:r, widths770:new Array(r.length-1).fill(10.2),
    start:{x:66,y:166}, goal:{x:112,y:166},
    safeZones:{start:{x0:60,y0:160,x1:72,y1:174},goal:{x0:106,y0:160,x1:118,y1:174}},
    sharedGate778:false, courseType775:'point-to-point', finishRule775:'end-gate', lapRequired775:false,
    strictRoadFollow778:true, strictNoChord795:true, extraRoads771:[], forbiddenZones770:[], roadMask770:undefined,
    roadFollowMode778:'clover-156-single-centre-route', racingLineMode772:'clover-yellow-9-11-12-1-3-5-green-v156'
  });
  // Disable all retired Clover routing modes that can compete with this route.
  for(const k of ['clover130','cloverRightBranch130','cloverCounterClockwise130','retiredSlot6HardCenter896','retiredSlot6CenterOnly895','retiredSlot6ExactCenter897','retiredSlot6SmartSpiral797','cloverOrderLock147','cloverDirectSplineMovement148']) clover[k]=false;
  const centre=densifyLine772(r,.10);
  clover.racingSpline770=centre; clover.globalOptimal770=centre;
  clover.lockOptimalExecution784=true; clover.optimizedSplineAuthority783=true;
  // If Clover is already selected, make runtime geometry match immediately.
  if(currentMap770()?.id==='double_hairpin'){
