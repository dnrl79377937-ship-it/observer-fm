...
function observerCountForMap120(map){
  ...
  (function auditLateMaps1650(){
    ...
    window.__OBSERVER_FM_MAP_CLEANUP_1660__={version:'v1.67.0',issues,obsoleteClover130131Removed:true,obsoleteClover142145Removed:true,lateMapBehaviorPreserved:true};
    if(issues.length) console.error('[v1.67.0] late-map audit',issues);
  })();
