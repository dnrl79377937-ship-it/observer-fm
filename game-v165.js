...
function observerCountForMap120(map){
  ...
  function applyPatch1410(){
    ...
    if(clover){
      ...
      clover.image='map_clover_164.png?v=1640';
      const route=[
  ...
  (function auditLateMaps1650(){
    ...
    window.__OBSERVER_FM_MAP_CLEANUP_1650__={version:'v1.65.0',issues,obsoleteClover130131Removed:true,lateMapBehaviorPreserved:true};
    if(issues.length) console.error('[v1.65.0] late-map audit',issues);
  })();
