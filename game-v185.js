...
(() => {
  ...
  function observerCountForMap791(m=currentMap770()){
    ...
    if(id==="double_hairpin")return 80;   // Three-Leaf Clover
    if(id==="cliff_hanger")return 70;    // 스카이클리프
    if(id==="skyway")return 80;           // 스페이스
    if(id==="s_map")return 70;           // 네온드리프트
    if(id==="star_fish")return 100;
    if(id==="triple_diamond")return 120;  // 데스티니게이트
    if(id==="ice_ring")return 150;
    if(id==="neon_city")return 120;       // 하트
    if(id==="desert_oasis")return 130;
    return 100;
  }
...
function seasonCardHtml(p){
  ...
  function v36SelfAudit(){
    ...
    if(observerCountForMap791(MAP_DEFINITIONS_770.double_hairpin)!==80)issues.push("Three-Leaf Clover observer count 80");
    ...
    if(observerCountForMap791(MAP_DEFINITIONS_770.s_map)!==70)issues.push("네온드리프트옵저버70");
    if(observerCountForMap791(MAP_DEFINITIONS_770.star_fish)!==100)issues.push("스타피쉬옵저버100");
    if(observerCountForMap791(MAP_DEFINITIONS_770.triple_diamond)!==120)issues.push("데스티니게이트옵저버120");
    if(observerCountForMap791(MAP_DEFINITIONS_770.ice_ring)!==150)issues.push("아이스크라운옵저버150");
    if(observerCountForMap791(MAP_DEFINITIONS_770.neon_city)!==120)issues.push("하트옵저버120");
    if(observerCountForMap791(MAP_DEFINITIONS_770.desert_oasis)!==130)issues.push("사막오아시스옵저버130");
  ...
  (function(){
    ...
    Object.assign(clover,{
      ...
      extraRoads771:[],forbiddenZones770:[],roadMask770:undefined,observerCount797:80,
    ...
    window.__OBSERVER_FM_MAP_CLEANUP_1630__={
      ...
      cloverStart:{...clover.start},cloverGoal:{...clover.goal},observerCount:80
    };
  })();
