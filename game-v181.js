...
function seasonCardHtml(p){
  ...
  (function(){
    ...
    for(const id of expected){
      ...
      img.onerror=()=>{report.assetChecks[id]={ok:false,image:m.image};report.ok=false;console.error('[v1.74.0] map image load failed',id,m.image);};
      img.src=m.image;
    }
  })();
