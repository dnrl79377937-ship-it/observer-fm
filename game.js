...
function applyMapSet776(){
  ...
  const meta={
    ...
    cliff_hanger:{slot:8,name:"스카이 클리프",en:"Sky Cliff",theme:"Frozen Cliff Run",tags:["좁은길","절벽","정밀"],image:"map_cliff_hanger_776.png?v=776-cliff-hanger",special:{shortcuts:false,obstacles:false,wideRoad:false,multiRoute:false,verticality:true}},
