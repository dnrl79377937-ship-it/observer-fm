...
function seasonCardHtml(p){
  ...
  (function(){
    ...
    window.__OBSERVER_FM_MAP_CLEANUP_1660__={version:'v1.72.0',issues,obsoleteClover130131Removed:true,obsoleteClover142145Removed:true,lateMapBehaviorPreserved:true,retiredSlot6FlagsPurged:true};
  ...
  (function(){
    ...
    window.__OBSERVER_FM_V172_AUDIT__={version:'v1.72.0',ids,bans,sets,issues};
