...
function seasonCardHtml(p){
  ...
  (function(){
    ...
    if(issues.length)console.error("[v1.71.0] map registry audit",issues);
  ...
  (function(){
    ...
    Object.assign(clover,{
      ...
      image:'map_clover_164.png?v=1710',imageSize:{w:1254,h:1254},logicalSize:{w:178,h:178},miniCrop:{x:0,y:0,w:178,h:178},
  ...
  (function(){
    ...
    window.__OBSERVER_FM_MAP_CLEANUP_1660__={version:'v1.71.0',issues,obsoleteClover130131Removed:true,obsoleteClover142145Removed:true,lateMapBehaviorPreserved:true,retiredSlot6FlagsPurged:true};
    if(issues.length) console.error('[v1.71.0] late-map audit',issues);
  })();

  // v1.71.0 starts on the fully randomized matchup board.
  resetLeague100();
})();
