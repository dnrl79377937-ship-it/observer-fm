...
(() => {
  ...
  function observerCountForMap791(m=currentMap770()){
    ...
    if(id==="double_hairpin")return 110;  // Three-Leaf Clover
    if(id==="cliff_hanger")return 100;   // 스카이클리프
    if(id==="skyway")return 90;           // 스페이스
    if(id==="s_map")return 80;           // 네온드리프트
    if(id==="star_fish")return 130;
    if(id==="triple_diamond")return 140;  // 데스티니게이트
    if(id==="ice_ring")return 160;
    if(id==="neon_city")return 160;       // 하트
    if(id==="desert_oasis")return 160;
    return 100;
  }
...
function seasonCardHtml(p){
  ...
  function v36SelfAudit(){
    ...
    if(observerCountForMap791(MAP_DEFINITIONS_770.double_hairpin)!==110)issues.push("Three-Leaf Clover observer count 110");
    ...
    if(observerCountForMap791(MAP_DEFINITIONS_770.star_fish)!==130)issues.push("스타피쉬옵저버130");
    if(observerCountForMap791(MAP_DEFINITIONS_770.triple_diamond)!==140)issues.push("데스티니게이트옵저버140");
    if(observerCountForMap791(MAP_DEFINITIONS_770.ice_ring)!==160)issues.push("아이스크라운옵저버160");
    if(observerCountForMap791(MAP_DEFINITIONS_770.neon_city)!==160)issues.push("하트옵저버160");
    if(observerCountForMap791(MAP_DEFINITIONS_770.desert_oasis)!==160)issues.push("사막오아시스옵저버160");
  ...
  (function(){
    ...
    Object.assign(clover,{
      ...
      extraRoads771:[],forbiddenZones770:[],roadMask770:undefined,observerCount797:110,
    ...
    window.__OBSERVER_FM_MAP_CLEANUP_1630__={
      ...
      cloverStart:{...clover.start},cloverGoal:{...clover.goal},observerCount:110
    };
  })();
