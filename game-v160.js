...
(function applyPatch1520(){
  ...
  // ============================================================
  // v1.60.0 — CLOVER SINGLE RUNTIME AUTHORITY
  // Root-cause fix: v1.57/v1.59 Clover overrides were appended AFTER the main
  // IIFE, where MAP_DEFINITIONS_770 is out of scope. They therefore never
  // became the runtime map authority. This patch lives inside the owning scope.
  // ============================================================
  (function applyPatch1600(){
    const c=MAP_DEFINITIONS_770.double_hairpin;
    if(!c)return;
    const r=[
      [73.5,162.6],[73.5,153],[73.5,143],[73.5,132],[73,121],[67,113],
      ...
      [105,121],[104.4,132],[104.4,143],[104.4,153],[104.4,162.7]
    ];
    const centre=densifyLine772(r,.10);
    Object.assign(c,{
      name:'Three-Leaf Clover',en:'Three-Leaf Clover',
      image:'map_clover_157.png?v=1600',imageSize:{w:1254,h:1254},logicalSize:{w:178,h:178},miniCrop:{x:0,y:0,w:178,h:178},
      ...
      strictRoadFollow778:true,strictNoChord795:true,roadFollowMode778:'clover-single-authority-v160',
      ...
      racingSpline770:centre,globalOptimal770:centre,lockOptimalExecution784:true,optimizedSplineAuthority783:true,
      racingLineMode772:'yellow-9-11-12-1-3-5-green-v160',geometryReady:true,approvedImageShape772:true
    });
    POINT_TO_POINT_MAPS_775.add('double_hairpin');
    CIRCUIT_MAPS_775.delete('double_hairpin');
    // If Clover is already active while this script initializes, rebuild every
    // geometry authority from this one route. No retired central spline survives.
    if(currentMap770()?.id==='double_hairpin'){
      activeMap770=c;MAP_W=178;MAP_H=178;resizeObserverGrid777();
      route=r.map(q=>[...q]);widths=[...c.widths770];
      GLOBAL_OPTIMAL_LINE_710=centre;RACING_SPLINE_720=centre;
      rebuildRouteGeometry770();rebuildGlobalOptimal770();rebuildRacingSpline770();
      applyMapImage770(c);
    }
    window.__OPF_BUILD__='v1.60.0';
    window.__OBSERVER_FM_V1600__={
      cloverAuthorityInsideMainScope:true,
      removedBrokenExternalCloverOverrides:true,
      start:[73.5,162.6],goal:[104.4,162.7],observerCount:150
    };
  })();
})();
